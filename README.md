...
| **ingestion** | External sources become standardized records, with a human gating what actually enters; the pull side. | reviewing-a-repo<br>processing-a-meeting | `reviewing-a-repo`<br>`processing-a-meeting` | source<br>ingestion<br>standardize<br>intake gate |
