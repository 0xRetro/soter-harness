...
| feature record | product-development | one card per feature — the tracked unit of product work: name, use-case (the why), status, owner, project-page link; mirrored to a Notion database |
