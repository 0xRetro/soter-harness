...
contextBridge.exposeInMainWorld('soterStudio', Object.freeze({
  ...
  describeConfigurationOnboarding: (request) => ipcRenderer.invoke('configuration:onboarding-describe', request),
  prepareConfigurationOnboarding: (request) => ipcRenderer.invoke('configuration:onboarding-plan', request),
  ...
  createReviewOnlyCandidateSelection: (request) => ipcRenderer.invoke('operator:review-only-candidate-selection-create', request),
  getReviewOnlyCandidateSelectionMaterial: (request) => ipcRenderer.invoke('operator:review-only-candidate-selection', request),
  createReviewOnlyCandidatePreview: (request) => ipcRenderer.invoke('operator:review-only-candidate-preview-create', request),
  getReviewOnlyCandidatePreview: (request) => ipcRenderer.invoke('operator:review-only-candidate-preview', request),
